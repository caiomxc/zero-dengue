...
namespace ZeroDengue.Controllers
{
    public class UsersController : Controller
    {
        ...
        public UsersController(ZeroDengueContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("UserId,Name,Email,Password,Ssn,PhoneNumber,Address")] User user)
        {
